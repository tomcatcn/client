...
function makeHeader(blog_username, username){
    ...
    header_body += '<h1 class="logo"><a href="/index"> ' + blog_username + '的wiki</a></h1>';
    ...
    header_body += '</ul>';
    header_body += '</li>';
    header_body += '<li><a href="/'+blog_username+'/photos">我的相册</a> </li>';
    header_body += '<li><a href=' + '"' + user_info_url + '"' + '>关于我</a> </li>';
    header_body += '<li><a href=' + '"' + topic_release_url + '"' + '>发表文章</a> </li>';
    header_body += '</nav>';
    header_body += '</div>';
    if (username){
...
function makeIndexHeader(username){
    //blog_username 当前访问的博客的作者
    //username   登陆的用户
    ...
    header_body += '<div class="menu">';
    header_body += ' <nav class="nav" id="topnav"> ';
    header_body += '<h1 class="logo"><a href="/index">wiki</a></h1>';
    header_body += '<li><a href="/index">网站首页</a></li>';
    header_body += '<li>';
    if(username){
header_body += '<a href=' + '"' + user_topics_url + '"' + '>文章列表</a>';
    ...
    header_body += '</ul>';
    header_body += '</li>';
    header_body += '<li><a href="/'+username+'/photos">我的相册</a> </li>';
    header_body += '<li><a href=' + '"' + user_info_url + '"' + '>关于我</a> </li>';
    header_body += '<li><a href=' + '"' + topic_release_url + '"' + '>发表文章</a> </li>';
    header_body += '</nav>';
    header_body += '</div>';
    ...
    header_body += '</header>';
     ...
     else{header_body += '<a href= "/login">文章列表</a>';
    header_body += '<ul class="sub-nav">';
    header_body += '<li><a href="/login">技术</a></li>';
    header_body += '<li><a href="/login">非技术</a></li>';
    header_body += '</ul>';
    header_body += '</li>';
    header_body += '<li><a href="/login">我的相册</a> </li>';
    header_body += '<li><a href="/login">关于我</a> </li>';
    header_body += '<li><a href=' + '"' + topic_release_url + '"' + '>发表文章</a> </li>';
    header_body += '</nav>';
    header_body += '</div>';
    if (username){
